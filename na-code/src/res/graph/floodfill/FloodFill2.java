...
public class FloodFill2 {
    ...
    public void floodfillStack(final int x, final int y, final int newColor, final int oldColor) {
        ...
        while (!stack.isEmpty()) {
            ...
            if (p.getX() + 1 < width) {
                final Point p1 = new Point(p.getX() + 1, p.getY());
            ...
            if (p.getX() - 1 >= 0) {
                final Point p2 = new Point(p.getX() - 1, p.getY());
            ...
            if (p.getY() + 1 < height) {
                final Point p3 = new Point(p.getX(), p.getY() + 1);
            ...
            if (p.getY() - 1 >= 0) {
                final Point p4 = new Point(p.getX(), p.getY() - 1);
